...
RGaddedSortedMarkdupBAM=$"${filename}_STAR_bowtie2_combined_markdup_woIntronMotif.bam"
##RGaddedSortedMarkdupMappedBAM=$"${filename}_STAR_bowtie2_combined_markdup_mapped.bam"
MarkdupMetrics=$"${filename}_markdup.metrics"
MarkdupSplitBAM=$"${filename}_markdup_cigarsplit_woIntronMotif.bam"
...
STARbowtieHTSeqGencodeCountsGT200=$"${filename}_STAR_bowtie2_combined_htseq_gencode_v19_gt200_wo_intronMotif.counts"
STARbowtieHTSeqGencodeCountsGT200_reverse=$"${filename}_STAR_bowtie2_combined_htseq_gencode_v19_gt200_reverse_woIntronMotif.counts"
