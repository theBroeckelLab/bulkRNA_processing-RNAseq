...
java -Xmx4g -jar /usr/local/picard/AddOrReplaceReadGroups.jar I=$STARbowtieSAM O=$RGaddedSortedBAM SO=coordinate RGID=$sample RGLB="RNA" RGPL="IONTORRENT" RGPU="Proton" RGSM=$sample VALIDATION_STRINGENCY=LENIENT
